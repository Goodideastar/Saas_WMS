    ...
    <el-dialog v-model="dialogVisible" title="新建出库单" width="800px">
      <el-form :model="orderForm" label-width="100px">
        ...
        <el-table :data="orderForm.items" border>
          ...
          <el-table-column label="应出数量">
            <template #default="{ row }">
              <el-input-number v-model="row.expectedQuantity" :min="1" />
            </template>
          </el-table-column>
          <el-table-column label="实出数量">
            <template #default="{ row }">
...
function handleCreate() { Object.assign(orderForm, { warehouseId: 1, customer: '', outboundType: '', relatedOrderNo: '', remark: '', items: [{ productId: null, expectedQuantity: 1, actualQuantity: 0, unitPrice: 0 }] }); dialogVisible.value = true }
